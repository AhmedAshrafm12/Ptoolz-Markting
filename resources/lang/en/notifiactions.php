...
// markting
 ...
 "new_marketer_sp_title"=>"new marketer add" ,
 "new_marketer_sp_body"=>"a new marketer add you" ,

 "marketer_team_accept_title"=>"leader accept" ,
 "marketer_team_accept_body"=>"markting leader accepted you" ,

 "marketer_team_decline_title"=>"leader decline" ,
 "marketer_team_decline_body"=>"markting leader declined your request" ,
